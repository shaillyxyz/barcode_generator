...
data$Plasma_vol <- ceiling(as.numeric(data$Plasma_vol))
...
write_csv(final_data, "C:/Users/quasid.akhter/Desktop/Barcode/Output_files/IHBT_20%_Plasma_Sec_Ids.csv")
